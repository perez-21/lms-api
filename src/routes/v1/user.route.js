...
router
  .route('/')
  .post(auth(Permissions.USER_CREATE), validate(userValidation.createUser), userController.createUser)
  .get(auth(Permissions.USER_READ), validate(userValidation.getUsers), userController.getUsers);
